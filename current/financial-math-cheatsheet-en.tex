...
% ----- pdf metadata -----
\hypersetup{
	pdftitle={Financial Mathematics Cheat Sheet},
...
\begin{center}
	...
	\begin{tabular}{|c|c|c|c|c|c|c|}
		\hline
		\multirow{2}{*}{\textbf{Period}} & \textbf{Interest} & \textbf{Amortization} &        \textbf{Interest}        &  \textbf{Amortization}  & \multirow{2}{*}{\textbf{Outstanding capital}} &     \multirow{2}{*}{\textbf{Amortized capital}}     \\
